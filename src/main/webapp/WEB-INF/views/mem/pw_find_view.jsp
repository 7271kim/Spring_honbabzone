...
<div class="contents-container">
     <div class="contents-join">
        <form id="join-form" name="join-form" autocomplete="off" action="pw_find.do" method="post" onsubmit="return loginSubmit();">
            <div class="logo"><h2 class="logo-label">FIND PW</h2></div>
            ...
            <div class="input_row" id="submit_area">
                <span class="input_box">
                    <label for="login-submit" id="label_submit_area" class="label blind">비밀번호 찾기</label>
                    <input type="submit" id="login-submit" title="join" name="login-submit" class="submit float-left j-button" value="비밀번호 찾기" >
